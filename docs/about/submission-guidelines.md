...
- [x] **A .STEP file of your project's 3D CAD model as well as the source design file format as well - .f3d, .FCStd, etc; for OnShape, add a public link to your README)**
