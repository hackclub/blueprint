...
# Parent's Guide to Blueprint to Prototype
...
Hack Club programs are free and accessible to all students. Blueprint to Prototype is a Hack Club program, where students are supported to create real hardware projects.
...
Blueprint is a hardware electronics program where we give out grants to teenagers to build hardware projects! From now until July 31, your child can make as many hardware projects as they want - and we'll fund up to 400 USD per project.

#### What is Prototype?

Prototype is a 4-day, in-person hardware hackathon event for high school students at GitHub HQ! Your child will get together with other teens from all over the world to try to make an electronics project in under 72 hours.
...
**Prototype is invite-only**; in order to recieve an invitation, your child will need to get to 4 points through Blueprint. You earn points through making projects!
...
- Laptop (and charger)
- Water bottle
- Any hardware they want to use (although we will have tons provided at Prototype)
- Their hardware project from Blueprint to showcase it to others! (if possible)
...
We are giving out limited travel stipends; see the [Prototype](Prototype) page for details.
