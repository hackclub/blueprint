...
![Folder Structure](/old-cdn/2937dfbe0936703899cece511669a0edc54c7efd_folder-structure.png)
(Folder structure)

![KiCad Project Files](/old-cdn/02816d068a1a60959bb0e6365f396a702800f679_kicad-project-files.png)
(KiCad project files)
...
![Servo PWM Signal](/old-cdn/fbba5610e535e0bd7dd9061bdb1bca6f9520b912_servo-pwm-50hz.png)

The `duty cycle` is the percentage of the period that the signal is high (on).

![PWM Duty Cycle](/old-cdn/dfa58b42380f88635d4898510995f8d17621203a_pwm-duty-cycle.png)
...
![TI Battery Charger Page](/old-cdn/d6432723b54aa82475fc61680db8eb9416ea0036_ti-battery-charger-page.png)
...
![TI DC/DC Power Modules](/old-cdn/5485b44bfcbdf47c671d59768d9c9ed748152a25_ti-dcdc-power-modules.png)
...
![LCSC Search](/old-cdn/6d46cca468d8ed4fca37d81d019dec3b15a68818_lcsc.png)
...
![LCSC Search](/old-cdn/ec20447082d2df2c068cad1a7c7b04b4d912da83_lcsc_usbc.png)

It should look like this:

![LCSC Search](/old-cdn/03e6a4678418f95bffe676e614429fed3ac59192_lcsc_txt.png)
...
![LCSC Search](/old-cdn/eb221640fbec7f23837dc4350dbde769145734ef_lcsc_script.png)
...
![LCSC Search](/old-cdn/6ff011c0b1db3493e8e85328a2df286e34758770_kicad_symbol.png)
![LCSC Search](/old-cdn/dd6687dfd4dd4d8d7b79465750410fc3791abf5e_kicad_footprint.png)
...
![LCSC Search](/old-cdn/365f855c838d8320b564685aa93b370a484c82bc_kicad_usbc.png)
...
![LCSC Search](/old-cdn/393b4eb069231176b8eb76e7b6d6661feb93cd74_kicad_pre.png)

After finding the components on LCSC, my `lcsc.txt` looks like this:

![LCSC Search](/old-cdn/64678d6f38b1e93c7c600222c4fe9a170c59b229_lcsc_done.png)
...
![LCSC Search](/old-cdn/5aa0d43b29d3966bb755930400ec9a955a36033b_kicad_start.png)
...
![LCSC Search](/old-cdn/3cef224c168e7de4e92507c1ede446f3412a80ef_usbc.png)
...
![LCSC Search](/old-cdn/159720619db037c2cf9504c755cb985c189212e3_usbc_done.png)
...
![LCSC Search](/old-cdn/4c28f281f13aebe8a9dbdd0ca940b8e641243f0b_datasheet_bat.png)
...
![LCSC Search](/old-cdn/e349d5af31c995f344ab90e6e34ae9a9a47b714c_datasheet_sch.png)

This is the schematic for a specific implementation, and we can see below that there is a table that describes it:

![LCSC Search](/old-cdn/5228fe7ee112b60df9369d919467b205e6f17e1b_datasheet_table.png)
...
![LCSC Search](/old-cdn/9ea846f444e104f74bf68ad5cce77f6c93758de5_datasheet_calc.png)
...
![Datasheet Pin Configuration](/old-cdn/f011cba7b3ac4e3753242034df4e72215f2feb0a_datasheet_pin_config.png)
...
![Net Labels Example](/old-cdn/98a8cd4ec01d8601acdc01184249e973e61c6861_net_labels_example.png)
...
![Digital Ground Symbol](/old-cdn/e749ca5629229308a49ba2be4295e5ca1dde2fc0_digital_ground_symbol.png)
...
![Power Ground Symbol](/old-cdn/1f9b90df2a7fc0b422e6369a6ce3972f6bde3b4d_power_ground_symbol.png)
...
![Battery Charger Schematic Complete](/old-cdn/58ba37abb0a047fa5eea159c5f8ca476629c82ac_battery_charger_complete.png)
...
![TPS63070 Adjustable Application](/old-cdn/d563f4ddeff3b72f081a77601c4f33f277bc570f_tps63070_adjustable.png)
A typical application that can be adjusted depending on your needs.

And if you scroll down a bit more:
![TPS63070 Fixed Voltage Application](/old-cdn/586f44f95da873cbd7a0c3eaba996dda57b91af7_tps63070_fixed.png)
...
![Voltage Divider Circuit](/old-cdn/4e405900e8a68972df11b37104da2234747800e2_voltage_divider_circuit.png)
...
![KiCad Component Value Setting](/old-cdn/d5db01401c162ba714abde5df30725a0562ba98d_kicad_component_value.png)
...
![TPS63070 Schematic Complete](/old-cdn/579d30360238a3af6c4b2500296c6f77f0df82a5_tps63070_schematic_complete.png)
...
![LMR51430 Switching Frequency Tables](/old-cdn/c2c003c8f0c2a754d10da8c861b01c4c79a9cf2e_lmr51430_switching_tables.png)
...
![LMR51430 Adjustable vs Fixed Schematic](/old-cdn/25e145f3104c174ecfafce4c491454cf103f6156_lmr51430_adjustable_vs_fixed.png)

After routing it, you should get something like this (for a 500 kHz switching frequency at 3.3V):

![LMR51430 Schematic Complete](/old-cdn/65dcea2001e0add1_image.png)
...
![BMP580 Pinout Diagram](/old-cdn/fd3b0ecb0ef175d694bc3bcb97560aad700a3879_bmp580_pinout.png)
...
![BMP580 I2C Schematic](/old-cdn/cf7bc0cf2019990da40c8508102c893f75a1472d_bmp580_i2c_schematic.png)

Following this schematic, after wiring it up in KiCad, you should get this:

![BMP580 KiCad Wired](/old-cdn/d61a0d62bf40d2104ece87a58e6fff91399f384a_bmp580_kicad_wired.png)
...
![ICM-45686 SPI Schematic](/old-cdn/91093a6afa2aab3180f57331f15e3a4953b419dc_icm45686_spi_schematic.png)
...
![ICM-45686 KiCad Wired](/old-cdn/17a5cc24631657793a6482987753cc03799cbf35_icm45686_kicad_wired.png)
...
![MicroSD Pinout Table](/old-cdn/1368ecdbe4c0da0ba65fa7630b56cef150c9a34b_microsd_pinout.png)
...
![MicroSD Pullup Requirements](/old-cdn/70d9b5177979f4ed131b8acf6d75e27911024cf6_microsd_pullup_requirements.png)

After wiring it up, you should get something like this:

![MicroSD KiCad Wired](/old-cdn/5affaf2d791825d5efef5c7ab7c298da871b5dca_microsd_kicad_wired.png)
...
![STM32CubeMX Startup Screen](/old-cdn/1798957db12ac9a10935d0f4d33f8a253c594d5b_stm32cubemx_startup.png)
...
![STM32CubeMX MCU Selector](/old-cdn/b284f0aa7617463dc5a9b27c5cd6c68eb9e33c57_stm32cubemx_mcu_selector.png)
...
![STM32F722RET6 Selected](/old-cdn/b3576e122a84ad794536c05e436f77b257198536_stm32cubemx_mcu_selected.png)
...
![STM32CubeMX Pinout Configuration](/old-cdn/73a1a83a53f8ecfc333b3b7571cd8ef6dead97d7_stm32cubemx_pinout_config.png)
...
![STM32CubeMX I2C Enabled](/old-cdn/27049091e21ed6f794ba0f727f537191e58ba7ef_stm32cubemx_i2c_enabled.png)
...
![STM32CubeMX BQ_INT GPIO Configuration](/old-cdn/2e11bb87c76fd8fa537fe8948019e0184a22e424_stm32cubemx_bq_int_gpio.png)
...
![STM32CubeMX BQ_CE GPIO Configuration](/old-cdn/4d9b3b29b10020c5d9728779270ece69d9c57b01_stm32cubemx_bq_ce_gpio.png)
...
![STM32CubeMX BMP580 Interrupt Configuration](/old-cdn/80c2a59bd8b85ac4a2672beabcb5ef21191ced7e_stm32cubemx_bmp_interrupt.png)
...
![STM32CubeMX SPI Configured](/old-cdn/c500c296dc42ffa3157cd5c80eef336e9e1f6361_stm32cubemx_spi_configured.png)

Also, don't forget to add the 2 interrupt pins on the IMU as GPIO_EXTIx (x is any number):

![STM32CubeMX IMU Interrupts](/old-cdn/684938f807fe0e3b58a65fbcbad5c28a4464435a_stm32cubemx_imu_interrupts.png)
...
![STM32CubeMX USB OTG Configuration](/old-cdn/644566c8defed3a1ce9f27c15f2d44ed007c04cd_stm32cubemx_usb_otg.png)
...
![STM32CubeMX SDMMC Enabled](/old-cdn/751aeac27931452c3b6f08421b021755527600a6_stm32cubemx_sdmmc_enabled.png)

Also, remember to add an extra pin next to it for the card detect pin and make it a GPIO_Input:

![STM32CubeMX SDMMC Card Detect](/old-cdn/70d2111b1516cdcd5ae22a58df15035460e64029_stm32cubemx_sdmmc_card_detect.png)
...
![STM32CubeMX RCC Configuration](/old-cdn/59a3a6b88e05ad56d7d0353c2fa1e40ff0ba5706_stm32cubemx_rcc_config.png)
...
![STM32CubeMX PWM Configuration](/old-cdn/07ea5869e3b6401972ea540180a778eb1b73d048_stm32cubemx_pwm_config.png)

**MAKE SURE TO SAVE USING CTRL+S AND CREATE A NEW FOLDER IN THE ROOT OF YOUR GITHUB REPOSITORY CALLED `firmware` OR `firmware`.**

![STM32CubeMX Save Location](/old-cdn/be24ef3122d8cea1d6630ebd394fa894baaf686f_stm32cubemx_save_location.png)

This is how my STM32 looks after selecting all of the pins:

![STM32CubeMX Final Pinout 1](/old-cdn/fb798901d2d129b6317aeca9bc488ef36c2892ef_stm32cubemx_final_pinout1.png)
![STM32CubeMX Final Pinout 2](/old-cdn/c87bf3996bea0834a1723249462dadae88036b17_stm32cubemx_final_pinout2.png)
![STM32CubeMX Final Pinout 3](/old-cdn/a5ad9b0d1c095d89720d6ca1e5f5e00776448e0e_stm32cubemx_final_pinout3.png)
...
![STM32 Reference Schematic](/old-cdn/08dc401cc68c607831e88961c57e243e08141771_stm32_reference_schematic.png)
...
![STM32 VDD/VSS Wiring](/old-cdn/e6095b36411c3e643774f58b9b3c081092aafb22_stm32_vdd_vss_wiring.png)
...
![KiCad Crystal Imports](/old-cdn/91691ac20c4f8df67c7ba200e6293171f460e566_kicad_crystal_imports.png)
...
![Crystal Load Capacitors Concept](/old-cdn/d3ba23499675e6512070856d276471b67ec2a60d_crystal_load_capacitors_concept.png)
...
![KiCad Crystals Wired](/old-cdn/7d531353b45a287cc72cf03fa251d3f715399aaa_kicad_crystals_wired.png)
...
![KiCad Reset and Boot Buttons](/old-cdn/30fb452fc658a7f7d414cae4a78d54add0af4619_kicad_reset_boot_buttons.png)
...
![KiCad Servo Headers](/old-cdn/7d3ab72b1f8376df7fe260b52a718d59f6b87dbb_kicad_servo_headers.png)
...
![KiCad Net Labels Schematic](/old-cdn/34c585b194b51e08bafcf92fd029c35b274fff5f_kicad_net_labels_schematic.png)
...
![KiCad I2C Connections 1](/old-cdn/e1a99f924c403e5ca44982fa1326b2f6ba094205_kicad_i2c_connections.png)
![KiCad I2C Connections 2](/old-cdn/4615f7bec5f04cd21c69819354efb5a45eadc97e_kicad_i2c_connections2.png)
...
![KiCad Page Settings](/old-cdn/8154fb8f6a1c8275191cf1bbe07fdc3c391211ce_kicad_page_settings.png)

Now after organizing it a bit, your schematic should look like this:

![KiCad Final Schematic](/old-cdn/86c7c8cc2b5632d2e4cbdc7bbabcc95df82542e4_kicad_final_schematic.png)
...
![alt text](/old-cdn/47bd7fde766bb2c548baa32176a3533c3103db33_footprint_assignment_button.png)

The lines in yellow are components whose footprints we have to assign:

![alt text](/old-cdn/1cb8be2bf72a5f041a41b00fd790e0ffd0edd4ce_footprint_assignment_list.png)
...
![alt text](/old-cdn/42be801f6fc4d7af4b65337780ca1afb4b01a196_footprint_remaining_symbols.png)
...
![alt text](/old-cdn/f8246043724ffe459aa341c245cff08d1e198467_header_footprints.png)

The inductors are a bit trickier. For this, you're gonna have to go into the datasheet and see where it says the size:

![alt text](/old-cdn/d8449e733e2ae102ba2db187f6254531169b35b5_inductor_datasheet_size.png)
...
![alt text](/old-cdn/f5c011b94dcb8880132b1bfbf4c25f4e2ada8786_inductor_value_correction.png)
...
![alt text](/old-cdn/5c74ad43a8d12b6293d3d5c8a165571429b15d21_pcb_import_button.png)

A screen should pop up:

![alt text](/old-cdn/38d7e9aa0d1f121cdd315f49eea2970d624b423c_pcb_update_from_schematic.png)

There should be no errors or warnings. Then press Update PCB to import everything from the schematic.

![alt text](/old-cdn/acc124764d7af00c01c48aab5526f883f428efbc_pcb_components_imported.png)
...
![alt text](/old-cdn/5e8975a52959dff20a3e83a73cd1b9c36cede118_pcb_layers_panel.png)
...
![alt text](/old-cdn/a84b22f03308e15d2e999dd0c2f0c62e3386d37d_schematic_usbc_selection.png)
...
![alt text](/old-cdn/bf96d2f4b657f7c458e53cf5cad485d0d5afd551_pcb_usbc_components_placed.png)

Do the same for each of the sections and after you've done that you should get something like this: 

![alt text](/old-cdn/51cd3927e5619231b3af5cd9604d8cd486de681a_pcb_all_groups_separated.png)
...
![alt text](/old-cdn/3b629c240ec77ab266a3a0afa108f11405ccf7c3_pcb_usbc_layout_example.png)
...
![alt text](/old-cdn/6b75e5537f105b5c5353c57aed6bc4d04d905716_pcb_3v3_buck_initial.png)
...
![alt text](/old-cdn/ec4820e3eabc124f44d0fae69a5be5e72f6fb5d0_pcb_3v3_buck_adjusted.png)
...
![alt text](/old-cdn/803dc0894d23718ebdefc5765b7360d2ded21e1b_pcb_5v_buck_boost_layout.png)
...
![alt text](/old-cdn/188b44883ac680256966226baef217e27d79acf7_pcb_5v_buck_boost_routed.png)

Moving on to the battery charger:

![alt text](/old-cdn/c50c289127f6626e398e1dd93f156aa9239ca0dc_pcb_battery_charger_layout.png)

Crystals:
![alt text](/old-cdn/76f227974fe3d2b921e392e30138a33b9446e04f_pcb_crystals_layout.png)

microSD Card:

![alt text](/old-cdn/41d6114e338889ba5d63748b70cfa9f866ba72e4_pcb_microsd_layout.png)
...
![alt text](/old-cdn/8c1f0de5244fd0ec0d7717ce06b3c9b516a39b67_pcb_stm32_orientation.png)

Also for these decoupling caps:
![alt text](/old-cdn/76502c959ad4635ccd32438fe04be6963847d750_pcb_bulk_decoupling_caps.png)
...
![alt text](/old-cdn/5dfeaa33d4b381d5c84d2e703e40e1cc59e76e8a_pcb_stm32_decoupling_layout.png)
...
![alt text](/old-cdn/dc1f136a2df1a4ca28bcb8c33d55769bf3cb4857_pcb_initial_board_layout.png)
...
**TIP**
![alt text](/old-cdn/92272445077cc29c87fd74e989962ff542e9123c_pcb_group_components_tip.png)
...
![alt text](/old-cdn/3ef2a6374abc23e6a60bff482baacbaf339947b9_pcb_final_layout_organized.png)
...
![alt text](/old-cdn/2f8a0dea520b2ac94f1f2f45f5c41641d1f7ba56_pcb_edge_cuts_tool.png)

This will be the PCB outline.

![alt text](/old-cdn/448816c6d568b80d56df0a55174900900238a363_pcb_board_outline_drawn.png)

![alt text](/old-cdn/a0be299721829a198f4767003db2bde317e1fe49_pcb_board_dimensions.png)
...
![alt text](/old-cdn/a8d0756383184e8dfe1608b29c6214f451bf6638_pcb_usbc_overhang.png)
...
![alt text](/old-cdn/5d9e172b022b401c32c22f828ad2da025c2590c1_pcb_3d_view_top.png)

![alt text](/old-cdn/fd2612614f050ddaf3424b4a6970b447ff157a89_pcb_3d_view_side.png)
...
![alt text](/old-cdn/8d91bc46653535a8416d3165bc3cff5bef3da659_pcb_predefined_sizes.png)
...
![alt text](/old-cdn/1aadb0c0da8763f5512198ce4104451067d8ac24_pcb_board_setup_constraints.png)

![alt text](/old-cdn/151af206137f6852dc0e64675b698ed13e723c66_pcb_constraints_settings.png)
...
![alt text](/old-cdn/5007b05f91d2c46e7748ab71fafc4dd2392e53ae_pcb_usb_differential_start.png)

Then go to `Route > Route Differential Pair` 
![alt text](/old-cdn/e3044760e0daa41c1c2f93a840b88a1a24e39881_pcb_route_differential_pair_menu.png)
and then click on the USB_DP to the far right:
![alt text](/old-cdn/f9bda1da977a8f5bbd12305a27a8ade3f0bda3a8_pcb_usb_differential_routing.png)
...
![alt text](/old-cdn/17ab1fcc961849b7c96f3142f1cb00eadc32fe91_pcb_track_width_dropdown.png)

![alt text](/old-cdn/531b3f680cbc585654d518cdafe03b0a691225dd_pcb_via_size_dropdown.png)
...
![IMU Decoupling Capacitors Routed](/old-cdn/db81f7f25a949b3e66bfc40fad4fe114817212ae_pcb_imu_decoupling_routed.png)
...
![Via Placement Example](/old-cdn/333c89c3eacdae130001e62cf12007d0a4beb12a_pcb_via_placement_example.png)
...
![VBUS Routing Issue](/old-cdn/c6fab4f979d8a0060f953e24ba58aa6cda776e7f_pcb_vbus_routing_issue.png)

![VBUS Routing Fixed](/old-cdn/ac63949260b423cb9e3545a33ce7e68caa42ae54_pcb_vbus_routing_fixed.png)
...
![alt text](/old-cdn/ce45b43a0986bfd9f7c09d50e6264f37e2999a2f_pcb_net_classes_clearance.png)

![alt text](/old-cdn/907eb54dbe539772ada718d0a0494d23abd6ada0_pcb_via_on_pad_placed.png)


This is how I routed the Battery charger:
![alt text](/old-cdn/f01878d60b3499c1f3119d121367adc095038a66_pcb_battery_charger_routed.png)
...
![alt text](/old-cdn/c03529ba4eee753126b6da05aa60ca9f3615b498_pcb_bmp580_i2c_routing.png)
...
![alt text](/old-cdn/2f7a053291e85d75db06de364503279d2fb4ecee_pcb_microsd_routed.png)
...
![alt text](/old-cdn/3b489d22eedc68b7b8af7e759accc98384f6952d_pcb_3v3_through_decoupling_caps.png)

After routing your board should look something like this:

![alt text](/old-cdn/6123dcda724abdbe564862cfd59c388e0b517837_pcb_all_routed_complete.png)
...
![alt text](/old-cdn/c3f4c371c8fd4741834a16bd88776552bde60f16_pcb_ground_pour_settings.png)
...
![alt text](/old-cdn/cc3274a0944f55f82864c3bea41ba4661f439a0e_pcb_ground_pour_outline.png)
...
![alt text](/old-cdn/e859b4408e82c40d7110b84e302d63c6321d0211_pcb_ground_pour_complete.png)
...
![alt text](/old-cdn/7f4ea2670025d1c5407cfa5b9f8970bd26e693bd_pcb_stitching_via_location.png)

![alt text](/old-cdn/0489a1ccd8b17372d37ac83946b4439ebb4ba2c3_pcb_stitching_via_placed.png)
...
![alt text](/old-cdn/703ebc948aacf286334890e817b472366d6ff5b0_pcb_ground_plane_disconnected.png)
...
![alt text](/old-cdn/ec259459e9e0e4c3d3ec97dab4e053765ff8d524_pcb_ground_plane_connected.png)
...
![alt text](/old-cdn/70c2572d368bbde4d8af647dafe78bf1b493eb01_pcb_thermal_pad_via.png)
(You can edit the properties by right clicking the pad and editing the `Net name`.)

![alt text](/old-cdn/3fe26fcb5a9cae8992bb10b34b497173445ac4bc_pcb_thermal_pad_net_edit.png)
...
![alt text](/old-cdn/36dd873c5b6c3f7f9e4329ad3f084c63c892d65b_pcb_pgnd_gnd_connection.png)
...
![alt text](/old-cdn/f6a6cf323c7105e70c08637bea442c94347b4722_pcb_drc_check_button.png)


Then click on `Run DRC`:

![alt text](/old-cdn/550bd5b3051d387fda135777b466598f695b90e5_pcb_drc_run_button.png)

![alt text](/old-cdn/9a99952db4d7dcb741463d6788c673ab0329500f_pcb_drc_results.png)
...
![alt text](/old-cdn/ca24efa42d21abb21263b99ff999a1f61d7e940e_pcb_drc_errors_from_imports.png)
...
![alt text](/old-cdn/ac3b345f193c7bde36330edcabd45c878d050897_pcb_text_graphics_menu.png)

This window should show up:
![alt text](/old-cdn/0f1bc20f8f294ffea47f49206060fb12132170de_pcb_reference_designators_window.png)
...
![alt text](/old-cdn/85edc6cf9f0421dd70af49c57c3ac9f0de3c0f29_pcb_silkscreen_font_settings.png)
...
![alt text](/old-cdn/712a95b8bd5dc06f155910859b92d2b0cb91bd29_pcb_silkscreen_before.png)
(before)
![alt text](/old-cdn/b84fb7526df22229a5b75049c35bd29c2c9b61e0_pcb_silkscreen_after.png)
(after)
...
![alt text](/old-cdn/6aa086f11b5db28d64eb4f1e5a0f1e14b202d60f_pcb_silkscreen_organized.png)
...
![alt text](/old-cdn/6e9d9f24a82f3ddf2646ef9358a2859d422eb5e9_pcb_3d_model_properties.png)
...
![3D Model Before](/old-cdn/2358fcf199d98f621b7d24eb48761363034edb07_pcb_3d_model_before.png)
(Before)

![3D Model After](/old-cdn/b7dd0f50ab2463ee9a4802534349867b1ffbac7d_pcb_3d_model_after.png)
(After)

And you're done!

![alt text](/old-cdn/50d7618ce15309279a6206f3cdfa7024a8a57cb3_pcb_final_complete.png)
...
![alt text](/old-cdn/a0641970cc3d80902ed1c175e30f17c2872ea231_jlcpcb_plugin_icon.png)
...
![alt text](/old-cdn/cbf1490de31b0932d2dcdc4515af6478308481e1_jlcpcb_plugin_install.png)
...
![alt text](/old-cdn/912cf846c397933d69b474862440ff35b3b6f185_jlcpcb_fabrication_icon.png)

A window should open and click `Generate`:

![alt text](/old-cdn/cd613f813c276c666a4f8dac1c326394d9614d5d_jlcpcb_generate_window.png)

It should create this directory in the `hardware` folder:

![alt text](/old-cdn/69d6c2eb3eb07c8b5d1597a030fc1bf6048a6483_jlcpcb_production_folder.png)

But I'm going to copy it out of that folder and move it to the root so that reviewing is much easier.

![alt text](/old-cdn/8352ad45cd7ccff9c36babb4455258598c247a99_production_folder_moved.png)
...
![alt text](/old-cdn/7e39144c9db40181e599d0ca5d7801a4b46a2949_jlcpcb_upload_gerbers.png)

Select `PCBA` and make sure that it is only one side and that you order 2 and not 5 boards assembled to minimize cost:

![alt text](/old-cdn/89c577fe501c0d75c65cffc5779a8c087aaf1398_jlcpcb_pcba_settings.png)
...
![alt text](/old-cdn/5d416a7f80f2a1edde04c7cddce06ae755dbeabe_jlcpcb_bom_cpl_upload.png)

Depending on the sensors you use, you may have to use standard PCBA:

![alt text](/old-cdn/fae08bdf789daec4ad92938e3bb98aa2ccf00408_jlcpcb_standard_pcba.png)
...
![alt text](/old-cdn/c228a66275da19d1c764edca0fd4b57594c1ec2d_jlcpcb_component_shortfall.png)

![alt text](/old-cdn/309859e47ab12113c2301b697d507e5930f1ad82_jlcpcb_parts_list.png)

Continue without placing the parts for now to get the general cost of the board:

![alt text](/old-cdn/d0959ff7ab616e8d3d994604bad7e69b68ada6ad_jlcpcb_final_cost.png)
...
![STM32CubeMX Toolchain Makefile](/old-cdn/40d409ff6b572200bf5ab31adcf420c17a31d84c_stm32cubemx_toolchain_makefile.png)
...
![VSCode STM32 Extension](/old-cdn/d346cc47c7e62ee781fbfc7e4bb14bc64d8d0b6c_vscode_stm32_extension.png)

Then you should see this button on the side:
![VSCode STM32 Sidebar Button](/old-cdn/184dc2fabc0d05636d18ecac6742d3b23ef22e47_vscode_stm32_sidebar_button.png)

This will allow you to build and flash your flight controller all from VSCode!

![VSCode STM32 Build and Flash](/old-cdn/e30b0ede9b8baeb1f998cc37b3211cf05f45cd24_vscode_stm32_build_flash.png)
